...
def main():
	...
	print('\n')
	print('Buy\n')	
	buy_filter = my_contract.events.Buy.createFilter(fromBlock=3257999, toBlock=3258001)
	print(buy_filter.get_all_entries())
	print('\n')
	print('Loan Payment\n')	
	loan_payment_filter = my_contract.events.LoanPayment.createFilter(fromBlock=3258135, toBlock=3258137)
	...
	print('\n')
	print('Transfer\n')	
	transfer_filter = my_contract.events.Transfer.createFilter(fromBlock=3258049, toBlock=3258051)
